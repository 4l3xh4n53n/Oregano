...
public abstract class AdministrativeCommand implements OreganoCommand {
     ...
     */
    protected static boolean checkPermissions(String guildID, String setting, Member author, Member mentioned, Permission requiredPermission){
     ...
     * @return boolean value, true of false depending on whether the author has the correct permissions or not
     */
    protected static boolean checkPermissions(String guildID, String setting, Member author, Permission requiredPermission){
        boolean authorHasPermission = false;

        if (SettingsManager.commandUsesPermissions(guildID, setting)){ // Discord permissions based authorization
